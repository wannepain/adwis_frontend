...
class HomepageStage2 extends ConsumerStatefulWidget {
  bool forceOpenAuth;
  HomepageStage2({super.key, this.forceOpenAuth = false});

  @override
  _HomepageState createState() => _HomepageState();
}

class _HomepageState extends ConsumerState<HomepageStage2> {
